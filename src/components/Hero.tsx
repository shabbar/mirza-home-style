      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center space-x-2 bg-luxury-gold/10 rounded-full px-5 py-2 border border-luxury-gold/20">
              <Star className="w-4 h-4 text-luxury-gold fill-luxury-gold" />
              <span className="text-sm font-semibold text-luxury-navy">Premium Interior Design Since 2004</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-2xl mx-auto mb-8">
            <div className="text-center p-4 rounded-lg bg-white/80 backdrop-blur-sm shadow-card border border-luxury-gold/10 hover:shadow-gold transition-all">
              <div className="text-3xl md:text-4xl font-bold text-luxury-gold mb-1">20+</div>
            ...
            <div className="text-center p-4 rounded-lg bg-white/80 backdrop-blur-sm shadow-card border border-luxury-gold/10 hover:shadow-gold transition-all">
              <div className="text-3xl md:text-4xl font-bold text-luxury-gold mb-1">98%</div>
              <div className="text-xs md:text-sm text-muted-foreground font-medium">Client Satisfaction</div>
            </div>
          </div>

          {/* Contact Info */}
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center text-luxury-navy bg-white/60 backdrop-blur-sm rounded-lg p-4 md:p-6 border border-luxury-gold/20 shadow-card">
